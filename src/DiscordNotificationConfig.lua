...
Config.Discord = {
    ...
    TitleMessageLoot = "|playerName| matou |bossName|!",
...
Config.ItemsVeryRare = {
    ...
    ["the crown of the percht queen (fire)"]= "The Crown of the Percht Queen (Fire)",
    ["the crown of the percht queen (ice)"]= "The Crown of the Percht Queen (Ice)",
...
Config.ItemsRare = {
    ...
    ["icicle (the percht queen)"] =  "Icicle (The Percht Queen)",
    ["impaler"] =  "Impaler",
    ["ivory comb"] =  "Ivory Comb",
    ["jade hammer"] =  "Jade Hammer",
    ["jade hat"] =  "Jade Hat",
    ["jagged sickle"] =  "Jagged Sickle",
    ["jewel case (azul)"] =  "Jewel Case (Azul)",
    ...
    ["pair of nightmare boots"] =  "Pair of Nightmare Boots",
    ["part of a rune (segunda)"] =  "Part of a Rune (Segunda)",
    ...
    ["signet ring (valioso)"] =  "Signet Ring (Valioso)",
    ["silver token"] =  "Silver Token",
    ...
    ["spirit container (fighting spirit)"] =  "Spirit Container (Fighting Spirit)",
    ...
    ["watermelon tourmaline (fatia)"] =  "Watermelon Tourmaline (Fatia)",
